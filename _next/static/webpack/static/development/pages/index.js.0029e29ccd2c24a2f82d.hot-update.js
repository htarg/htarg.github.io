...
function Footer() {
  return __jsx("footer", {
    ...
    className: "text-2xl lg:text-3xl font-bold tracking-tighter leading-tight text-center lg:text-left mb-10 lg:mb-0 lg:pr-4 lg:w-1/2",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9,
    ...
    className: "mx-3 bg-blue hover:bg-white hover:text-blue border border-blue text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13,
...
//# sourceMappingURL=index.js.0029e29ccd2c24a2f82d.hot-update.js.map