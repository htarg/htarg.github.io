...
function Footer() {
  return __jsx("footer", {
    className: "bg-blue-100 border-t border-blue-400",
    __self: this,
    __source: {
    ...
    className: "py-10 flex flex-col lg:flex-row items-center text-blue-900",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8,
...
//# sourceMappingURL=index.js.e9987f16b61754a90cf6.hot-update.js.map